...
const DeclineModal = ({ show, onDeclineClick, onCloseClick, loading }) => {
  ...
  return (
   ...
   <ModalBody className="py-3 px-5">
       ...
       <img src={warningIcon} alt=""  />
         <h4 className='pt-5'>Decline Transaction</h4>
          <p>You are about to decline a transaction for a FlipEx user, Please kindy be sure to verify transaction before declining.</p>
       </div>
